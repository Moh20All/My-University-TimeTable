...
public class Section extends AppCompatActivity {
    ...
    private List<SectionApi> sectionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        niveau = getIntent().getIntExtra("niveau", -1); // Retrieve departmentId from intent
    ...
    public void downLoadJsonDataLevel() {
        String url = "https://num.univ-biskra.dz/psp/pspapi/section?level_specialty="+lvlId+"&semester=2&key=appmob";
        final LoadingDialog loadingDialog = new LoadingDialog(Section.this);
                ...
                response -> {
                    try {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            Log.d("LevelApiResponse", "LevelApi: " + section.toString());
                        }
    ...
    private void createButtons() {
        ...
        for (final SectionApi speciality : sectionList) {
            Button button = new Button(this);
            if(Objects.equals(language, "fr")){
                button.setText("Section "+speciality.getIdYear());
            }else{
                button.setText(speciality.getAbbreviationAr());
            }
            button.setId(speciality.getSectionId());
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(Section.this, Group.class);
                    intent.putExtra("secId",button.getId());
                    intent.putExtra("facultyId",facultyId);
                    intent.putExtra("departmentId",departmentId);
                    intent.putExtra("specId",specId);
                    intent.putExtra("lvlId",niveau);
